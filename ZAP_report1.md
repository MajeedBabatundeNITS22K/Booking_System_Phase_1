...
* URL: http://0.0.0.0:8000/register
  * Method: POST
  * Parameter: username
  * Attack: `johndoe@example.com AND 1=1 -- `
  * Evidence: ``
  * Other Info: `The page results were successfully manipulated using the boolean conditions [johndoe@example.com AND 1=1 -- ] and [johndoe@example.com AND 1=2 -- ]
...
* URL: http://0.0.0.0:8000/register
  * Method: POST
  * Parameter: username
  * Attack: `johndoe@example.com OR 1=1 -- `
  * Evidence: ``
  * Other Info: `The page results were successfully manipulated using the boolean conditions [johndoe@example.com AND 1=1 -- ] and [johndoe@example.com OR 1=1 -- ]
The parameter value being modified was NOT stripped from the HTML output for the purposes of the comparison.
